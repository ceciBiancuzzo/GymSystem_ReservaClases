...
import gymsystem.utils.FechaUtil;
...
//mostrame la clase
    ...
    public ClaseAux(Integer idClase, ObjectProperty<LocalTime> hora, ObjectProperty<LocalDate> fecha, TipoClase tipoClase) {
    ...
    public ClaseAux(int idClase, LocalTime hora,
    ...
    public ClaseAux(LocalTime hora, LocalDate fecha, TipoClase tipoClase) {
        this.fecha = this.fecha = new SimpleObjectProperty(fecha);
        this.hora = this.hora = new SimpleObjectProperty(hora);
        this.tipoClase = tipoClase;
    }

    public ClaseAux(LocalTime hora, LocalDate fecha) {
        this.hora = this.hora = new SimpleObjectProperty(hora);
        this.fecha = this.fecha = new SimpleObjectProperty(fecha);
    }

    public ClaseAux(LocalTime hora, LocalDate fecha, int idTipoClase) {
        this.fecha = this.fecha = new SimpleObjectProperty(fecha);
        this.hora = this.hora = new SimpleObjectProperty(hora);
        this.tipoClase = tipoClase;
    }

    public ClaseAux(Integer idClase, LocalTime toLocalTime, LocalDate toLocalDate) {
        this.idClase = new SimpleIntegerProperty(idClase);
        this.hora = this.hora = new SimpleObjectProperty(hora);
        this.fecha = this.fecha = new SimpleObjectProperty(fecha);
    }

    public ClaseAux(Integer idClase, Time hora, Date fecha) {
        this.idClase = new SimpleIntegerProperty(idClase);
        this.hora = this.hora = new SimpleObjectProperty(hora);
        this.fecha = this.fecha = new SimpleObjectProperty(fecha);
    }

    public ClaseAux(LocalDate toLocalDate) {
        this.fecha = this.fecha = new SimpleObjectProperty(fecha);
    }
//

    public ClaseAux(Integer idClase) {
        this.idClase = new SimpleIntegerProperty(idClase);
    }
    ...
    public String toString() {
        return idClase.get() + " | " + fecha.get() + " | " + hora.get();
